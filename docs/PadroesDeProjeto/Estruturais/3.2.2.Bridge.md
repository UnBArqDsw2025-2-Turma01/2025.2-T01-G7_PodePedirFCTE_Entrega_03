...
```
📱 [WhatsApp] +5561999999999 → +5561988888888
Pedido #P-2025-001 — Cantina FCTE
Cliente: Ana Silva
Itens: 2 | Total Itens: R$ 38.00
Taxa de entrega: R$ 5.90
Total: R$ 43.90
Criado em: 24/10/2025, 11:40:11

📧 [Email] no-reply@podepedir.fcte → ana.silva@fcte.br
Assunto: Comprovante do Pedido #P-2025-001
Pedido #P-2025-001
...
Itens:
 - X-FCTE x1 = R$ 22.00
 - Suco Laranja x2 = R$ 16.00

Subtotal: R$ 38.00
Taxa entrega: R$ 5.90
Total: R$ 43.90
Data/Hora: 24/10/2025, 11:40:11

🔗 [Webhook] POST https://api.parceiro.dev/webhook/pedidos (destino=erp.parceiro
)
Payload:
Pedido #P-2025-001
Fornecedor: Cantina FCTE
...
- Horários e datas são populados no momento da execução do código.

---
### Execução

O arquivo a seguir contém o código executável com a estrutura acima abordada. [Link para download.](https://drive.google.com/file/d/1mGMF3fZBrrYUFSoOqeSdyT0kxVHhEGNT/view?usp=sharing)
...
| :--------: | :----: | :-------------------------------- | :----------------------------------------: | :----------------------------------------: | :-------------: |
| 21/10/2025 |  `1.0`   | Criação da página. | [`@storch7`](https://github.com/storch7) | [`@Ana Joyce`](github.com/anajoyceamorim) |   24/10/2025    |
| 21/10/2025 |  `1.1`   | Arquivo executável e saída esperada | [`@storch7`](https://github.com/storch7) | [`@Ana Joyce`](github.com/anajoyceamorim) |   24/10/2025    |
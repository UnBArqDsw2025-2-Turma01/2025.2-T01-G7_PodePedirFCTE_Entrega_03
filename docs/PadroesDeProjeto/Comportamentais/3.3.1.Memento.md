...
##### Classe CarrinhoDeCompras (Originator)
...
##### Classe HistoricoCarrinho (Caretaker)
...
```ts
Item adicionado: Pizza Calabresa
Estado do carrinho salvo!
Item adicionado: Refrigerante
Estado do carrinho salvo!
Item adicionado: Sobremesa
Carrinho atual: Pizza Calabresa, Refrigerante, Sobremesa
↩Carrinho restaurado para estado anterior!
Carrinho atual: Pizza Calabresa, Refrigerante
↩Carrinho restaurado para estado anterior!
Carrinho atual: Pizza Calabresa
```

<font size="2"><p style="text-align: center"><b>Autor:</b> <a href="https://github.com/Joao151104">João Filipe de Oliveira Souza</a>, 2025</p></font>

## Vídeo de Apresentação e demonstração da execução do código

- [Execução do Código](https://youtu.be/s1OLHSQOZIs)</br>
...
| :--------------------------------------------------- | :--------------------------------------------------------------------------------------------- |
| [João Filipe de Oliveira Souza](https://github.com/) | Desenvolvimento da implementação e pesquisa sobre o GOF Memento                                |
| [Nathan Batista Santos](https://github.com/)         | Desenvolvimento da página do GOF comportamental Memento, com diagrama UML e criação do vídeo   |
| [Cayo Felipe Alencar](https://github.com/)           | Desenvolvimento da documentação e pesquisa sobre o GOF Memento e produção do vídeo explicativo |
...
> REFATORING GURU. _Memento_. Disponível em: https://refactoring.guru/pt-br/design-patterns/memento. Acesso em: 22 out. 2025.
...
| 1.2    | 23/10/2025 | Adição da implementação do Memento               | [João Filipe de Oliveira Souza](https://github.com/Joao151104)                                   |             |                     |

...
- **Os Consumidores do Singleton:** Qualquer outro componente do sistema (como um gerenciador de pagamentos ou um serviço de notificações) que precise interagir com o orquestrador, deve obrigatoriamente invocar o método estático `OrquestradorDePedidos.getInstance()` para obter a referência do objeto. Conforme aponta Serrano (2025), isso garante que, independentemente de quantos consumidores existam ou de onde eles estejam no código, todos estarão operando sobre a _mesma e única instância_ do orquestrador, centralizando de fato o controle do fluxo dos pedidos..
...
## Vídeo de Apresentação e demonstração da execução do código

- [Vídeo de Apresentação](https://youtu.be/QCTno0iVlQ4)</br>
...
| :--------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------- |
| [João Filipe de Oliveira Souza](https://github.com/) | Desenvolvimento da implementação e pesquisa sobre o GOF Singleton                                                  |
| [Nathan Batista Santos](https://github.com/)         | Desenvolvimento da página do GOF criacional Singleton, com estruturação da página, diagrama UML e criação do vídeo |
| [Cayo Felipe Alencar](https://github.com/)           | Desenvolvimento da documentação e pesquisa sobre o GOF Singleton e produção do vídeo explicativo                   |

## Bibliografia

> Refactoring Guru. _Singleton_. Disponível em: [https://refactoring.guru/pt-br/design-patterns/singleton](https://refactoring.guru/pt-br/design-patterns/singleton). Acesso em: 27 maio 2025.
...
| 1.2    | 20/10/2025 | Implementação do Singleton                                                     | [João Souza ](https://github.com/Joao151104)                                                     |                                                |                                                                                                                                                                                                        |
| 1.3    | 20/10/2025 | Criação do Diagrama de Classes                                                 | [Nathan Batista ](https://github.com/Nathan-bs)                                                  |                                                |                                                                                                                                                                                                        |
| 1.4    | 24/10/2025 | Adição do Vídeo de Apresentação                                                | [Nathan Batista ](https://github.com/Nathan-bs) e [Cayo Alencar](https://github.com/Cayoalencar) |                                                |                                                                                                                                                                                                        |

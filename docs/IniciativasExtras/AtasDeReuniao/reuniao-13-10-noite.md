...
**Data:** Segunda-feira, 13 de Setembro de 2025 - 09h
...
|:-----------:|:---------------------------:|:---------------------------------------------------------------------------------------------:|:------------------------------:|:-------------------:|
| 1 | Documento com a divisão dos GOFs a serem feitos | Foi criado um documento para poder organizar quem está trabalhando com qual GOF para a entrega. | - | Feito |
| 2 | Modelo de página para os GOFs | Foi criado um modelo de página para a explicação dos GOFs desenvolvidos no projeto. | [Ana Clara](https://github.com/anabborges) | Feito |
| 3 | Uso do projects no GitHub | O projects será utilizado para auxiliar a guiar o desenvolvimento das páginas dos GOFs, verificando o que está sendo feito, o que já foi feito e o que ainda precisa ser feito | [Ana Clara](https://github.com/anabborges), [Ana Joyce](https://github.com/anajoyceamorim), [Cayo](https://github.com/Cayoalencar), [Fábio](https://github.com/fabinsz), [Gabriela](https://github.com/gaubiela), [Guilherme](https://github.com/storch7), [João Filipe](https://github.com/Joao151104), [Luiz](https://github.com/luizfaria1989), [Nathan](https://github.com/Nathan-bs), [Rodrigo](https://github.com/rodrigoFAmaral) e [Willian](https://github.com/Wooo589) | Feito |
